...
- `DEVIL_N_DOVE_SOAP_LABEL_AUTOMATION_SPEC_V1.md` — compatibility pointer to `PACKAGING_STUDIO.md`; do not edit as a second specification.
...
- `database_upgrade_current_pass.sql` — identical current pass; apply one migration file, not both.
- `BUILD224_VALIDATION.md` — retained for the product-detail seven-image gallery hotfix.
- `BUILD223_VALIDATION.md` — retained for the preceding product-detail runtime repair.
- `BUILD222_VALIDATION.md` — retained for the underlying Soap Label Studio schema/features.
