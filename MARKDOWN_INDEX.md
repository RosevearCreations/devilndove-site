...
1. `AI_HANDOFF.md` — architecture, data authority, safety, routes, migration and deploy sequence.
2. `PROJECT_STATUS_AND_ROADMAP.md` — completed work, launch position, known risks and ordered next steps.
