...
- Three aggregate schema files include Builds 229 and 230; current-pass SQL is identical to the Build 230 numbered migration and has no explicit transaction statements.
- Startup authority contains 43 unique gates; all 42 prior keys remain and the distinct Critical missing-image gate was added.
...
- Labeling & Packaging remains one whole-business system; three supplied sources are checksum-registered and visible, while the old soap route remains a compatibility pointer.
