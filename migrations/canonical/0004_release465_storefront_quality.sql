...
-- New Products may not bypass the review/publish flow by being inserted directly as active.
...
BEGIN
  ...
  THEN RAISE(ABORT, 'release465_product_not_ready_for_storefront') END;
END;
