> Current repo sync — 2026-05-09: this pass touched admin accounting UI, accounting import APIs, dashboard summary APIs, shared CSS, main schema SQL files, and all Markdown docs. Keep future passes one-step-at-a-time with docs/schema updated beside code.
