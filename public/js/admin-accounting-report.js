  ...
  function renderReport(data, costing) {
    ...
    if (stats) {
      stats.innerHTML = `
        ...
        <div class="admin-stat"><div class="admin-stat-label">Recognized overhead COGS</div><div class="admin-stat-value">${escapeHtml(centsToMoney(Number(costingSummary.estimated_recognized_overhead_cogs_cents || 0)))}</div></div>
        ...
        <div class="admin-stat"><div class="admin-stat-label">Units sold this month</div><div class="admin-stat-value">${escapeHtml(String(Number(costingSummary.sold_quantity_in_period || 0)))}</div></div>
