...
document.addEventListener('DOMContentLoaded', () => {
  ...
  mount.innerHTML = `
    <div class="card" id="release-sanity-card" style="margin-top:18px">
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap"><button class="btn primary" id="runReleaseSanityButton" type="button">Run release sanity</button><a class="btn" href="/admin/catalog/">Open Catalog Sync</a><a class="btn" href="/admin/accounting/#db-sanity">Open DB Sanity</a></div>
