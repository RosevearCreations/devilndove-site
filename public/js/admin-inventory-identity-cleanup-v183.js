...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  function render(){
    mount.innerHTML='<section class="card inventory-identity-cleanup" aria-labelledby="inventoryIdentityCleanupHeading">'
      +'<div class="section-heading-row"><div><p class="inventory-operations-eyebrow">Release 467 Build 201 · Cycle Count & Duplicate Identity Resolution</p><h3 id="inventoryIdentityCleanupHeading">Tool & Supply Identity Review</h3><p class="small">Supplier/source evidence remains available, while Build 201 makes duplicate identities and count-due work explicit. Duplicate rows never merge automatically; physical counts never save automatically.</p></div><button class="btn primary" type="button" id="inventoryIdentityCleanupSummaryButton">Load identity health</button></div>'
