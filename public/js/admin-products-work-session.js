// Release 467 Build 101 — browser-local Product Work Priority & Next-Action Ordering.
...
(() => {
  ...
  ready(() => {
    ...
    function setSortMode(mode) { if(!SORT_MODES.includes(mode))return; session.sort_mode=mode; saveSession(); }
