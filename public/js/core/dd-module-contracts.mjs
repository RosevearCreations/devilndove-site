// Devil n Dove Build 282 cross-module contract catalog.
// Contracts are declarative in this build. They do not provide implementations
// and do not permit direct access to another module's internal tables.

function contract(id, owner, consumers, description) {
...
export const DD_MODULE_CONTRACTS = Object.freeze([
  contract('catalog-read', 'catalog', ['public', 'operations', 'packaging', 'marketing', 'accounting'], 'Read stable product/catalog identity and presentation facts.'),
  contract('inventory-read', 'inventory', ['operations', 'creative', 'packaging'], 'Read inventory identity, source and reusable material facts without mutating stock.'),
  ...
  contract('content-media', 'content', ['public', 'catalog', 'packaging'], 'Select or read approved media references managed by Content authority.'),
