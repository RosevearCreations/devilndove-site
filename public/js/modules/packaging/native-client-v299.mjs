// Devil n Dove Build 299 native Packaging browser client.
// Removes Build 297 startup-readiness dependency while preserving Build 298 native
// read/write semantics. Readiness comes directly from the Build 290 Packaging runtime
// and its owner contracts. No retired browser compatibility route is named or called.
  ...
  waitPromise = new Promise((resolve) => {
    ...
    const finish = (ready) => {
      ...
      if (typeof document !== 'undefined') {
        document.removeEventListener(RUNTIME_READY_EVENT, onReady);
    ...
    if (typeof document !== 'undefined') {
      document.addEventListener(RUNTIME_READY_EVENT, onReady);
...
async function readPackaging(projectId = 0) {
  ...
  if (!ready) {
    lastReadStatus = 503;
    lastReadError = 'Packaging modular runtime owner contracts did not become ready.';
  ...
  const composed = {
    ...
    module_contracts: {
      ...
      client_build: BUILD,
      runtime_dependency: 'packaging-runtime-active',
      ...
      native_client: true,
      build297_readiness_dependency: false,
  ...
  if (typeof document !== 'undefined' && typeof CustomEvent !== 'undefined') {
    document.dispatchEvent(new CustomEvent('dd:packaging-contract-bootstrap', {
      detail: Object.freeze({
        ...
        build: BUILD,
        nativeClient: true,
        runtimeDependency: 'packaging-runtime-active',
...
export function getStatus() {
  ...
  return Object.freeze({
    ...
    nativeClient: true,
    runtimeDependencyEvent: RUNTIME_READY_EVENT,
    runtimeBuild: Number(status?.build || 0),
    runtimeState: status?.state || 'not-ready',
    build297ReadinessDependency: false,
...
export const metadata = Object.freeze({
  ...
  nativeWritePath: NATIVE_WRITE_PATH,
  legacyRouteNamedByClient: false,
  behaviorMode: 'runtime-native-packaging-client-facade',
});

if (typeof globalThis !== 'undefined') {
  globalThis.DDPackagingNativeClientRuntimeV299 = Object.freeze({
    build: BUILD,
    request,
    getStatus,
    getBootstrapStatus,
