...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function referenceMeta(reference, productId) {
    ...
    const map = {
      ...
      product_finished_inventory_lots: { label: 'Finished inventory lot provenance', href: `/admin/creative-process/?product_id=${encodeURIComponent(productId)}`, help: 'A finished inventory lot preserves production and downstream commitment provenance. Review the lot/production history; do not erase it through Product cleanup.' },
      ...
      product_costs: { label: 'Historical Product costs', href: '/admin/accounting/', help: 'Historical Product cost evidence belongs to Accounting and must remain auditable even if the Product is archived.' },
