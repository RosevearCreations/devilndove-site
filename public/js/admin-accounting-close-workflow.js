    ...
    mount.innerHTML = `
      <div class="card" id="accountingCloseWorkflowCard" style="margin-top:18px">
        ...
        <details style="margin-top:12px" open><summary>Accountant export packaging</summary>
          <div style="display:flex;gap:8px;flex-wrap:wrap;margin:8px 0"><button class="btn primary" type="button" id="createExportManifestButton">Create export manifest</button><a class="btn" href="/api/admin/accounting-period-summary-export" target="_blank" rel="noopener">Open period export endpoint</a><a class="btn" href="/api/admin/accounting-year-end-close" target="_blank" rel="noopener">Open year-end bundle endpoint</a></div>
