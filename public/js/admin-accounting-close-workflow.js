...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function wire() {
    ...
    document.getElementById('queueHstReminderButton')?.addEventListener('click', async () => { const form = document.getElementById('hstReviewForm'); const payload = form ? Object.fromEntries(new FormData(form).entries()) : {}; payload.action = 'queue_hst_reminder'; await post(payload).catch((error) => setMsg(error.message, true)); });
