...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  async function load(){
    mount.innerHTML='<section class="card" style="margin-top:18px"><p class="small">Running Release 467 Build 279 diagnostics; immutable verified evidence is shown once above…</p></section>';
    try{
      ...
      mount.innerHTML=`<section class="card" style="margin-top:18px"><p class="eyebrow">Release 467 Build 279</p><h2>Multipart Interruption & Resume Acceptance Drill</h2><p class="small">Current action only. The immutable Build 278 Development/Production GREEN predecessor is recovered by the shared release evidence. Build 279 exercises the final Development-only multipart interruption, reconnect, reselection and resume boundary.</p><p class="small"><strong>Closure outcome:</strong> a GREEN Build 279 runtime proof preserves upload identity and completed ETag state, proves incomplete completion fails closed, aborts the unfinished drill multipart, and closes current-release CAIP acceptance at 3/3.</p><p class="small"><strong>Production GREEN authority:</strong> immutable verified evidence is shown once in the shared summary above.</p><p class="small"><strong>Evidence pack ID:</strong> <code>${esc(pack.evidence_id)}</code></p><div style="display:flex;gap:8px;flex-wrap:wrap"><button class="btn" id="itRefresh">Refresh diagnostics</button><button class="btn secondary" id="itVerify">Verify immutable closure artifacts</button><button class="btn secondary" id="itExportMd">Export Markdown</button><button class="btn secondary" id="itExportJson">Export JSON</button><a class="btn secondary" href="/admin/reliability/">Reliability</a><a class="btn secondary" href="/admin/deployment-preflight/">Deployment Preflight</a></div><div id="itVerifyResult" class="small" aria-live="polite" style="margin-top:10px">Cross-artifact verification has not been run in this browser session.</div></section><section class="card" style="margin-top:16px"><h2>External acceptance policy</h2><p class="small">External acceptance remains separately governed; Build 279 requires real Development runtime evidence and does not change Production public exposure.</p></section><section class="card" style="margin-top:16px"><h2>Safety boundary</h2><p class="small">Build 279 limits mutation to the bounded Development multipart drill, aborts the exact unfinished upload after evidence, and performs no Production R2 mutation, Inventory/Finance movement, public promotion, provider action, workflow deletion or branch-protection change.</p></section>`;
