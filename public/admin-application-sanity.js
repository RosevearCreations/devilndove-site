document.addEventListener('DOMContentLoaded', () => {
  ...
  function render(data) {
    ...
    mount.innerHTML = `
      ...
      <div class="sanity-toolbar card"><button class="btn" data-action="seed_all" type="button">Refresh sanity rows</button><button class="btn secondary" data-action="save_snapshot" type="button">Save sanity snapshot</button><a class="btn secondary" href="/admin/deployment-preflight/">Open Preflight</a><a class="btn secondary" href="/admin/image-manifest/">Open Image Manifest</a></div>
