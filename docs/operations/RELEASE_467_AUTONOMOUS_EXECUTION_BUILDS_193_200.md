...
| **198** | Storefront Media Fit, Actionable Attention & Contextual Help | Preserve the full uploaded Product image by default, make operational attention say what/where/owner, and provide reusable circled-i Online Help across public, Admin and Creator surfaces. |
...
- Builds 187–197: **complete and Production GREEN**.
...
- **Build 197 — complete**: Sitewide Placeholder Integrity & Cycling proved 29 placeholders across 22 public pages, corrected seven hidden source/catalog inconsistencies, and added stable sitewide placeholder preparation.
- **Build 198 — current**: Storefront Media Fit, Actionable Attention & Contextual Help. Owner acceptance after Build 197 showed automatic Storefront image cropping, opaque operational-attention summaries, and a need for reusable contextual Online Help across user, Admin and Creator workflows.
- **Build 199 — next after Build 198 is fully GREEN**: Buyer Readiness Repair Workbench.
- Builds 200–204: planned, not started.
...
Build 198 was inserted after owner acceptance on Production-GREEN Build 197 exposed three cross-application usability problems. Storefront Product cards were forcing approved uploads through square `object-fit: cover` framing and silently clipping image content; Today Needs Attention surfaced counts and raw threshold codes without making the affected area and owning workflow obvious; and existing Help was either static or limited to external-provider fields. Build 198 keeps the full uploaded Product image visible by default, reserves crop/recenter work for explicit Product Media editing, makes operational attention actionable, and introduces shared role-aware contextual help. The previously planned buyer-through-launch sequence is shifted one build later, through Build 204.
