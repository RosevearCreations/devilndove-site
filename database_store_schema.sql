-- Build 246 scope: current additive D1 migration is database_build246_product_project_production_packaging.sql. This store overlay remains scoped; use database_full_schema.sql for the complete supported aggregate.
