...
Build 163 adds a dedicated Product Readiness preview workspace, D1-backed readiness endpoint, image/SEO readiness counters on the Admin Dashboard, a gift-card artwork placeholder, and updated predeploy checks. It also records the next 20-step roadmap in the handoff docs while keeping one-H1 checks and CSS sanity passing.
