...
- These assets are illustrations, not photographs of Devil n Dove inventory, people, premises, manufacturing proof, product condition, regulatory evidence or customer results.
- Do not use them in Product/Offer structured data, launch-product galleries, marketplace item proof, Google Business Profile real-photo slots, packaging print proof or before/after evidence.
...
- **Public route:** `/`
- **Role:** Editorial category/workshop-discovery signpost.
- **Prompt summary:** Intentionally illustrated eclectic maker workbench with jewelry tools, a ring and mandrel, engraved wood tag, soap, candle, botanicals and a vintage art-book cue; charcoal, cream, orange-red and icy-blue brand palette; generous quiet space; no text, logo, watermark or claim of actual inventory.
- **Desktop:** `/assets/generated/editorial/workshop-discovery-illustration.webp` — 1536×1024, 261,452 bytes, SHA-256 `dfec6faef75127e75dd8d91a0b41ac6048186be8cbb8a7d7e41d42b72f92d03f`
- **Phone/tablet:** `/assets/generated/editorial/workshop-discovery-illustration-768.webp` — 768×512, 79,676 bytes, SHA-256 `2e1c2ac85f7934b5a211899bb32a345db5ef0b8fe82a2171488ec99249c6c5d6`
- **Current disclosure:** “Illustrated workshop overview; current products and materials vary.”
- **Prohibited use:** actual workshop, process, product or local-business photographic proof.

## Asset 2 — Handmade jewelry techniques illustration

- **Public route:** `/handmade-jewelry-ontario/`
- **Role:** Editorial explanation of techniques/material paths.
- **Prompt summary:** Editorial macro illustration with a textured metal ring, ring mandrel, polymer-clay earring pieces, pliers, wire and sketches; no text, logo, watermark or actual-inventory claim.
- **Desktop:** `/assets/generated/editorial/handmade-jewelry-techniques-illustration.webp` — 1536×1024, 269,602 bytes, SHA-256 `4c99b7b054a7f0333d157b073725664a77becf11b29f9d83ed91bfc140b53267`
- **Phone/tablet:** `/assets/generated/editorial/handmade-jewelry-techniques-illustration-768.webp` — 768×512, 73,766 bytes, SHA-256 `8534956d09f15d5a79acc98c8e045a00d932abc19b1e793e5af4b5581019a13b`
- **Current disclosure:** The page says it is an editorial illustration and not a product currently for sale.
- **Prohibited use:** jewelry-item close-up, product condition, surface-quality or marketplace proof.

## Asset 3 — Gift-card brand illustration

- **Public route:** `/gift-cards/`
- **Role:** Decorative gift-card page artwork.
- **Prompt summary:** Decorative brand illustration balancing a pale icy-blue dove with warm orange flame forms, workshop tools, ring and engraved tag; large cream negative space; no text, amount, currency, QR code, watermark or promise of a physical card.
- **Desktop:** `/assets/generated/editorial/gift-card-brand-illustration.webp` — 1536×1024, 268,510 bytes, SHA-256 `4ae58aab03776005b5ab68b802e30e6a6150d4a5058633a20d9d5f785026a766`
