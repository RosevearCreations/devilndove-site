#!/usr/bin/env python3
"""Release 467 Build 174 — Product Editor Media read-collapse proof."""
...
for token in ('Release 467 • Build 174','admin-product-editor-v163.js?v=174',"reads only this Product's canonical gallery rows",'does not re-read the Product table','Open the full Image Editor only when you need recovery'):
