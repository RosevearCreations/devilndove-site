#!/usr/bin/env python3
"""Build 244 local /assets reference audit."""
...
out={'build_label':'Build 244','reference_count':len(refs),'missing_count':len(missing),'missing':missing}
(ROOT/'data/site/build244-asset-reference-audit.json').write_text(json.dumps(out,indent=2)+'\n',encoding='utf-8')
