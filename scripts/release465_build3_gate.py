...
workflow=read('.github/workflows/system-gate.yml');has(workflow,'release465_build3_gate.py','release465_performance_budget_gate.py','release465_regression_evidence.py','release465-build3-development-deploy-proof','release465-build3-regression-evidence',label='System Gate historical Build 3 coverage')
