...
asset URL safety/parity/native restore, lot-aware production/reversal, barcode receiving,
Inventory integrity, Product integrity, and Tool lifecycle source contracts. It never contacts
Cloudflare, D1, R2 or providers.
"""
