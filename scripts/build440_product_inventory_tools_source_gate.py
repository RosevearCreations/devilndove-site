...
source provenance cleanup, kit/component depletion, Inventory integrity, Product integrity,
and Tool lifecycle contracts. It never contacts Cloudflare, D1, R2 or providers.
"""
