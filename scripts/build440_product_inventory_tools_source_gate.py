...
resource persistence/identity normalization, asset URL safety/parity/native restore,
lot-aware production/reversal, barcode receiving, source provenance cleanup,
kit/component depletion, Inventory integrity, Product integrity, and Tool lifecycle.
