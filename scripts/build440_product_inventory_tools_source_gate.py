...
asset URL safety/parity/restore safety, production reversal, Inventory integrity,
...
STEPS=(
 ...
 ('Build 440 Development Inventory Asset Restore safety regression',[PYTHON,'scripts/build440_development_inventory_asset_restore_regression_test.py']),
 ('Build 440 Windows Development R2 Restore launcher regression',[PYTHON,'scripts/build440_development_inventory_asset_restore_windows_regression_test.py']),
 ...
 ('Build 440 Inventory asset parity UI JavaScript syntax',['node','--check','public/js/admin-inventory-asset-parity.js']),
 ('Build 440 guarded Development R2 restore Python syntax',[PYTHON,'-m','py_compile','scripts/build440_development_inventory_asset_restore.py']),
 ('Build 440 Windows Development R2 restore launcher Python syntax',[PYTHON,'-m','py_compile','scripts/build440_development_inventory_asset_restore_windows.py']),
