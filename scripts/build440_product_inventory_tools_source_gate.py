...
asset URL safety/parity, production reversal, Inventory integrity, Product integrity,
and Tool lifecycle source contracts. It never contacts Cloudflare, D1, R2 or providers.
"""
