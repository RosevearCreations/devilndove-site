...
# selected-provider Social OAuth, read-only I.T. diagnostics, immutable Build 87-96 closure,
...
# Build 96 browser-local Product search/focus, and Build 97 read-only Product readiness work queue,
# blocked/ready focus and existing-blocker navigation. External acceptance remains separate,
# technical GREEN remains distinct from launch READY, Canada-only commerce is preserved, and
# provider execution/publication plus automatic Production promotion remain closed.
...
run_current_contract('scripts/release467_build97_gate.py', 'Release 467 Build 97')
