...
for n in range(62,95):
    path=f'scripts/release467_build{n}_gate.py'
    if (ROOT/path).is_file(): run_current_contract(path,f'Release 467 Build {n}')
run_current_contract('scripts/release467_build135_gate.py','Release 467 Build 135')
if FAIL:
