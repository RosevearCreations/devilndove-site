...
# canonical Inventory package/base conversion and partial-consumption safety, or
# the fail-closed Inventory receive/reserve/use/return/write-off/reorder lifecycle.
