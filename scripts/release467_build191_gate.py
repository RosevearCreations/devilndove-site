...
req("Build 190 — complete" in roadmap and ((("Build 191 — current" in roadmap) and ("Build 192 — next after Build 191 is fully GREEN" in roadmap)) or (("Build 191 — complete" in roadmap) and (("Build 192 — current and final planned build in this sequence" in roadmap) or ("Build 192 — complete" in roadmap)))),"Build 191/192 roadmap checkpoint missing")
