...
help_html=read('admin/help/index.html');req(len(re.findall(r'<h1(?:\s|>)',help_html,re.I))==1,'online help must contain exactly one H1');req('noindex,nofollow' in help_html,'admin help must remain noindex,nofollow');req('Password' in help_html and 'SEO' in help_html and 'responsive' in help_html.lower() and 'Production' in help_html,'online help is missing current operating topics')
