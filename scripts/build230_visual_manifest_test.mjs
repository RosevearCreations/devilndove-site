...
assert(startupItems.length===45,`Expected the current 45 Startup gates, found ${startupItems.length}.`);
assert(new Set(startupItems.map((item)=>item.key)).size===45,'Startup keys must remain unique.');
