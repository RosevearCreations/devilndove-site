...
assert(startupItems.length===46,`Expected the current 46 Startup gates, found ${startupItems.length}.`);
assert(new Set(startupItems.map((item)=>item.key)).size===46,'Startup keys must remain unique.');
