...
def main() -> int:
    ...
    checks = [
        ...
        ('Inventory Operations page mounts and loads the review workspace', 'inventoryIntegrityReviewMount' in page and any(token in page for token in ('admin-inventory-integrity-review.js?v=179','admin-inventory-integrity-review.js?v=180','admin-inventory-integrity-review.js?v=201')) and 'inventory-integrity-review.css?v=440' in page),
