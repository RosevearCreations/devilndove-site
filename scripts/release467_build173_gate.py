#!/usr/bin/env python3
"""Release 467 Build 173 — Product media publication/save/rendering repair proof."""
...
checks={
  ...
  'Product Editor cache bumped': 'Release 467 • Build 173' in editor_page and 'admin-product-editor-v163.js?v=173' in editor_page,
