...
def main() -> int:
    ...
    checks = [
        ...
        ('recovery requires linked historical upload authority', 'no linked historical upload row' in recovery and 'recovery_of_file_id' in recovery),
        ...
        ('recovery creates a safe replacement under existing intake authority', 'createSafeReplacementUpload' in recovery and 'previous_missing_object_not_deleted' in recovery),
        ...
        ('existing creative asset identity is preserved', 'existing_asset_identity_preserved: true' in recovery and 'targetAssetId' in recovery and 'UPDATE creative_assets SET' in recovery),
    ...
    print('Missing binary recovery: SOURCE READY / EXPLICIT / R2-VERIFIED')
