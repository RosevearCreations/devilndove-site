...
req(pointer.get('build')==235 and pointer.get('next_build')==236,'Current authority must advance Build 235 → Build 236')
req(pointer.get('production_checkpoint',{}).get('main_sha')=='5d7e86d25eb114ddfd2a0ede877a0dcf5a866507','Build 234 Production predecessor mismatch')
