...
FILES = [
    'database_schema.sql','database_full_schema.sql','database_store_schema.sql',
...
# Controlled classifications are lower-case; human/external display values intentionally preserve case.
...
if errors:
    print('Build 246 database case audit: FAIL')
    for e in errors: print('-',e)
    raise SystemExit(1)
print('Build 246 database case audit: PASS')
