...
assert(read('database_upgrade_current_pass.sql').includes('build243_inventory_resilience_case_normalization'),'Current-pass SQL must point at the current Build 243 migration while Build 241 remains retained history.');
