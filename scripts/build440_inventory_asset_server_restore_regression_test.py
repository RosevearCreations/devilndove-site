...
check('/public/js/admin-inventory-asset-parity.js?v=440.7' in page, 'Inventory Operations cache-busts the corrected native restore UI')
...
print('Source integrity: SHA256 + SIZE/TYPE/TRUNCATION BOUNDED')
