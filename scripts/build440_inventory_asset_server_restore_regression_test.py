...
check("DND_ENVIRONMENT" in api and "dev.devilndove-site.pages.dev" in api and "isDevelopmentHost(request, env)" in api and "code: 'development_only'" in api, 'restore endpoint requires canonical Development environment and refuses Production')
