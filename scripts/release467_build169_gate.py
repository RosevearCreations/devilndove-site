...
for token in ('Build 169','data-editor-tab="qa"','productEditorQaRun','performs zero D1 reads','does not create tables'):
...
for forbidden in ('setInterval(','MutationObserver(','product-qa-panel-state'):
