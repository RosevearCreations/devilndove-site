#!/usr/bin/env python3
"""Release 467 Build 169 — explicit low-read Product QA/editor convergence gate, successor-aware through Build 178."""
...
req(any(token in page for token in ('Build 169','Build 173','Build 174','Build 175','Build 178')),'Build 169+ Product Editor identity missing')
