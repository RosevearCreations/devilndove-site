#!/usr/bin/env python3
"""Build 241 public page audit: one H1, title/meta/canonical, crawlable links, image alt/assets and structured data."""
...
BUILD = "Build 241"
OUTPUT = ROOT / "data/site/build241-public-page-audit.json"
