...
FILES = ['database_schema.sql','database_full_schema.sql','database_store_schema.sql','database_build243_inventory_resilience_case_normalization.sql','database_upgrade_current_pass.sql']
errors=[]
objects=0
...
if errors:
    print('Build 243 database case audit: FAIL')
    for e in errors: print('-',e)
    raise SystemExit(1)
print('Build 243 database case audit: PASS')
