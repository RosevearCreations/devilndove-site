#!/usr/bin/env python3
"""Build 245 public page audit: one H1, title/meta/canonical, crawlable links, image alt/assets and structured data."""
...
BUILD = "Build 245"
OUTPUT = ROOT / "data/site/build245-public-page-audit.json"
