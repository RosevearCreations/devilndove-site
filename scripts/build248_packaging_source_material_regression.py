...
check('current pass is Build 248 or newer', mig==current or b'Devil n Dove Build 249' in current or b'Devil n Dove Build 250' in current)
...
check('API build 248',"const BUILD = '248'" in api)
check('JS Build 248','Build 248' in js[:500])
...
check('rose renderer authority',"const roseAsset = rosePreset?.path || ''" in js)
...
check('soap-base-only formula inheritance','can inherit only a soap-base source template' in api)
check('source UI sections',all(x in js for x in ['Purchased/source material templates','Finished soap formula library','Supplier benefits / characteristics','Supplier allergen statement / characteristics']))
...
check('formula apply attaches source dependency',"action:'apply_source_material_template'" in js and 'Its purchased soap-base dependency is attached for source review' in js)
...
check('Build 248 handoff retained under current handoff', handoff.startswith('# Build 248 current handoff') or handoff.startswith('# Build 249 current handoff') or handoff.startswith('# Build 250 current handoff'))
check('Build 248 roadmap retained under current roadmap', roadmap.startswith('# Devil n Dove Project Status and Roadmap — Build 248') or roadmap.startswith('# Devil n Dove Project Status and Roadmap — Build 249') or roadmap.startswith('# Devil n Dove Project Status and Roadmap — Build 250'))
...
root_build_md=[p.name for p in root.glob('BUILD*.md') if p.name not in {'BUILD248_CHANGED_FILES.md','BUILD248_VALIDATION.md','BUILD249_CHANGED_FILES.md','BUILD249_VALIDATION.md','BUILD250_CHANGED_FILES.md','BUILD250_VALIDATION.md'}]
