...
mf=[x.get('file') for x in m.get('migrations',[]) if isinstance(x,dict)];q(len(mf)>=22 and mf[21]=='0022_release467_capability_profile_coverage_closure.sql','Build 231 retained canonical 0001-0022 boundary drifted')
...
print('Build 231 canonical boundary: NONE ADDED / retained 0001-0022 prefix')
