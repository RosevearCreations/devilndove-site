...
req('MutationObserver' not in trust,'Build 145 Product trust helper still uses a DOM MutationObserver')
...
req('/public/js/product-detail-v166.js?v=179' in page and '/public/js/seo-page-overrides.js?v=179' in page,'Product page Build 179 cache keys missing')
req('document.documentElement' not in overlay,'Image-quality overlay still observes the full documentElement')
...
req('Release 467 Build 179' in studio,'Media Studio Build 179 identity missing')
req('release467-build179-runtime-recovery.css?v=179' in inventory and 'Release 467 Build 179' in inventory,'Inventory Build 179 page recovery not loaded')
...
req('Release 467 Build 179 · Inventory truth &amp; usage' in inventory_ui,'Inventory integrity current operator label missing')
