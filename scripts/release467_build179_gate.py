...
req(any(token in inventory for token in ('release467-build179-runtime-recovery.css?v=179','release467-build179-runtime-recovery.css?v=180')) and any(token in inventory for token in ('Release 467 Build 179','Release 467 Build 180','Release 467 Build 183','Release 467 Build 185','Release 467 Build 189','Release 467 Build 203')),'Inventory Build 179/180/183/185 page recovery not loaded')
...
req(any(token in inventory_ui for token in ('Release 467 Build 179 · Inventory truth &amp; usage','Release 467 Build 180 · staged Inventory truth &amp; usage','Release 467 Build 201 · explicit cycle-count workflow')),'Inventory integrity current/successor operator label missing')
