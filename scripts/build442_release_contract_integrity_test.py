...
for required in ('build442_cross_mutation_responsive_acceptance_test.py','build442_it_platform_migration_regression.py','build442_it_release_obstacle_bridge_test.py','build440_product_inventory_tools_source_gate.py','build441_repository_hygiene_test.py'):
...
for marker in ('Build 442','CAIP','HOLD','IT-442-H1','PAY-442-H1','PAY-442-H2','96e3256b608190a8780829ea9e6409670a898fb4','Production promotion: **CLOSED**'):
...
print('Stripe, PayPal, CAIP and unresolved evidence: CARRIED AS BUILD 442 HOLDS')
