...
check('Inventory Operations uses inventory bundle v253', 'admin-site-item-inventory.js?v=253' in inv_html)
check('Mobile Inventory uses inventory bundle v253', 'admin-site-item-inventory.js?v=253' in mobile_html)
