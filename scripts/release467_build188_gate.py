...
req((("Build 187 — complete" in roadmap and "Build 188 — current" in roadmap and "Build 189 — next after Build 188 is fully GREEN" in roadmap) or ("Build 188 — complete" in roadmap and (("Build 189 — current" in roadmap) or ("Build 189 — complete" in roadmap)))),"Build 188/189 roadmap checkpoint missing")
