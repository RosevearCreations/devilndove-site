...
req("Build 191 — complete" in roadmap and (("Build 192 — current and final planned build in this sequence" in roadmap) or (("Build 192 — complete" in roadmap) and ("CLOSED / Production GREEN" in roadmap) and (("Build 193 — next/current planned work" in successor_roadmap) or ("Build 193 — complete" in successor_roadmap and "Build 194 — current" in successor_roadmap) or ("Build 194 — complete" in successor_roadmap and "Build 195 — current" in successor_roadmap)))),"Build 192 roadmap checkpoint missing")
for token in (
