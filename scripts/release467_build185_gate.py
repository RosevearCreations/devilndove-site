#!/usr/bin/env python3
"""Release 467 Build 185 — Product resource/cost/usage linkage gate, successor-aware through Build 186."""
...
req(any(token in page for token in ("Release 467 Build 185","Release 467 Build 189","Release 467 Build 203")) and any(token in page for token in ("admin-product-resources.js?v=185","admin-product-resources.js?v=467.191")),"Inventory Operations lost Build 185 Product-resource successor contract")
