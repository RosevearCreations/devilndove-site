...
req(any(token in page for token in ("Release 467 Build 185","Release 467 Build 189")) and "admin-product-resources.js?v=185" in page,"Inventory Operations lost Build 185 Product-resource successor contract")
