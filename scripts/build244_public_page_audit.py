#!/usr/bin/env python3
"""Build 244 public page audit: one H1, title/meta/canonical, crawlable links, image alt/assets and structured data."""
...
BUILD = "Build 244"
OUTPUT = ROOT / "data/site/build244-public-page-audit.json"
