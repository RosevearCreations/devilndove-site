...
allowed_scripts = {
    ...
    'build440_inventory_kit_runtime_contract_test.mjs', 'build440_product_inventory_tools_source_gate.py',
    'build440_public_inventory_authority_regression.py', 'build440_resume_development_d1.py',
    'build440_sync_development_release.py', 'build440_sync_full_schema.py', 'build440_sync_lot_provenance_full_schema.py',
    'build440_sync_receiving_full_schema.py', 'build440_verify_development_d1_final.py',
