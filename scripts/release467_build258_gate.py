...
q(int(p.get('build') or 0)==258 and int(p.get('next_build') or 0)==259 and p.get('state')=='DEVELOPMENT_GREEN','Current authority must expose Build 258 and successor 259')
