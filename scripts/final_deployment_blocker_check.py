...
REQUIRED_FILES = [
    ...
    'docs/archive/build-history/BUILD242_VALIDATION.md',
    'docs/archive/build-history/BUILD242_CHANGED_FILES.md',
    'database_build243_inventory_resilience_case_normalization.sql',
    'docs/archive/build-history/BUILD243_VALIDATION.md',
    'docs/archive/build-history/BUILD243_CHANGED_FILES.md',
