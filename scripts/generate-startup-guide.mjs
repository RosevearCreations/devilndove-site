...
const lines=['# Devil n Dove Startup and Go-Live Guide — Build 232','',
...
lines.push('## Gate count and authority','',`This guide contains ${items.length} gates. If it differs from the D1 cockpit after deployment, use the Build 232 API seed, confirm all ${items.length} items return, and keep the gate Failed until the status authority and guide agree.`,'');
