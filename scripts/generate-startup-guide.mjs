...
const lines=['# Devil n Dove Startup and Go-Live Guide — Build 240','',
...
lines.push('## Gate count and authority','',`This guide contains ${items.length} gates. If it differs from the D1 cockpit after deployment, use the Build 240 API definition, confirm all ${items.length} items return, and keep the gate Failed until the status authority and guide agree.`,'');
