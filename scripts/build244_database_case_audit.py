...
FILES = ['database_schema.sql','database_full_schema.sql','database_store_schema.sql','database_build243_inventory_resilience_case_normalization.sql','database_build244_inventory_authority_fractional_usage.sql','database_upgrade_current_pass.sql']
errors=[]
objects=0
...
if errors:
    print('Build 244 database case audit: FAIL')
    for e in errors: print('-',e)
    raise SystemExit(1)
print('Build 244 database case audit: PASS')
