#!/usr/bin/env python3
"""Build 246 public page audit: one H1, title/meta/canonical, crawlable links, image alt/assets and structured data."""
...
BUILD = "Build 246"
OUTPUT = ROOT / "data/site/build246-public-page-audit.json"
