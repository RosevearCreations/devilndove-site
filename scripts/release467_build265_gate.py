...
if cur==265:
    ...
    q((cur==266 and (p.get('production_checkpoint') or {}).get('main_sha')=='28181d75fe8425244848ae5a06c86f54a446eb1b') or (cur>=267 and (p.get('production_checkpoint') or {}).get('main_sha')=='1d4a1c204d19c4ecca16dd8dd6952b5107327db8'),'Build 266+ current Production baseline must be exact Build 265 or Build 266 successor closure')
