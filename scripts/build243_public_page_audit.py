#!/usr/bin/env python3
"""Build 243 public page audit: one H1, title/meta/canonical, crawlable links, image alt/assets and structured data."""
...
BUILD = "Build 243"
OUTPUT = ROOT / "data/site/build243-public-page-audit.json"
