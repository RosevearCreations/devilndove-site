...
req(any(token in auth_ui for token in ("/public/js/admin-context-help.js?v=467b198-shared-help","/public/js/admin-context-help.js?v=467b233-universal-help","/public/js/admin-context-help.js?v=467b234-workflow-recovery")), "Admin/creator shared help bootstrap revision missing")
help_bootstrap = next((token for token in ("/public/js/admin-context-help.js?v=467b234-workflow-recovery","/public/js/admin-context-help.js?v=467b233-universal-help","/public/js/admin-context-help.js?v=467b198-shared-help") if token in auth_ui), "")
req(auth_ui.index(help_bootstrap) < auth_ui.index("if (!leanStartup)"), "Shared Admin help must load even on lean workspaces")
req('data-dd-context-help-style="true"' in middleware and any(token in middleware for token in ("/public/js/admin-context-help.js?v=467b198-shared-help","/public/js/admin-context-help.js?v=467b233-universal-help","/public/js/admin-context-help.js?v=467b234-workflow-recovery")), "Public middleware shared help injection missing")
