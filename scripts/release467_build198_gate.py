...
help_bootstraps=("/public/js/admin-context-help.js?v=467b198-shared-help","/public/js/admin-context-help.js?v=467b233-universal-help","/public/js/admin-context-help.js?v=467b234-workflow-help")
help_bootstrap=next((token for token in help_bootstraps if token in auth_ui),None)
req(bool(help_bootstrap),"Admin/creator shared help bootstrap revision missing")
if help_bootstrap:
    req(auth_ui.index(help_bootstrap) < auth_ui.index("if (!leanStartup)"), "Shared Admin help must load even on lean workspaces")
req('data-dd-context-help-style="true"' in middleware and any(token in middleware for token in help_bootstraps), "Public middleware shared help injection missing")
