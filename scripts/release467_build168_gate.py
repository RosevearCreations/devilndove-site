...
Successor-aware through Build 174: retained invariants are browser-session reuse, no Products-table
...
req(any(token in editor_page for token in ('Build 168','Build 169','Build 173','Build 174')),'Product Editor is not a recognized Build 168+ successor')
