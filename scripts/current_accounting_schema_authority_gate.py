...
req(pointer_build >= 38, 'Build 38 Accounting authority cannot be evaluated before its accepted Development baseline')
...
req(authority.get('state') == 'DEVELOPMENT_GREEN', 'Build 38 Accounting authority must remain Development GREEN after acceptance')
