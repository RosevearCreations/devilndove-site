...
def main() -> int:
    ...
    check('/admin/catalog' in routes and '/admin/inventory' in routes and '/admin/orders' in routes and '/admin/membership' in routes and "'/api/admin/customer-documents'" in routes, 'Commerce & Operations owns Catalog/Inventory/Orders/Membership and Customer Documents API routes')
