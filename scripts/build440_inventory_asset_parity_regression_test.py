...
check('inventoryAssetParityMount' in page and '/public/js/admin-inventory-asset-parity.js?v=440.7' in page, 'Inventory Operations mounts and cache-busts the corrected parity review')
