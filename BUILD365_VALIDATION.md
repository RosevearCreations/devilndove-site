...
The Development database therefore has a usable `membership_tier_policies` table with Bronze, Silver, and Gold rows. No Membership table parity deficit was observed in this Development database.
...
The regression was corrected to inspect the executable read section instead of matching explanatory comments.

## Corrected local regression — PASSED 2026-08-25
...
This closes Build 365. No additional Firefox proof is required unless the implementation changes again.

## Final state

```text
Builds 362–364   fully validated after Build 365 read correction
Build 365        fully validated
GET mutation     false
Membership mutation ownership moved false
```
