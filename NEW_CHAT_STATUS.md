# New Chat Status — Build 278 Pointer
...
Build 278 adds an admin-only page-wide public Edit switch and a live Media Studio checklist for all 139 static visual slots; no D1 migration is required.
