// Release 467 Build 230 — current read-only prototype-to-run pilot over exact Build 229 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=230;
export const CURRENT_RELIABILITY_TITLE='Cost, Margin, QA & Knowledge Evidence Adoption';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:35677766514,build_specific_proof_run:35677766604,exact_preview_deployment:true,
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:230,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:230,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
      ...
      closure_candidate_requires_external_exact_head_proof:true,build229_route_to_proof_production_green:true,build229_business_exit:'HOLD_NO_REAL_PROJECT',
      ...
      successor_builds_planned:'230-232',production_baseline_build:229
    },
