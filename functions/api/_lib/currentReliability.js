...
export async function loadCurrentReliability(db, env = {}) {
  ...
  return {
    ...
    provenance: {
      ...
      build85_socials_oauth_acceptance_development_and_production_green: true,
      build86_it_operations_self_diagnostics_candidate: true,
      build86_read_only_projection: true,
      build86_automatic_repair: false,
      production_baseline_build: 85
    },
    safety: {
      ...inherited.safety,
