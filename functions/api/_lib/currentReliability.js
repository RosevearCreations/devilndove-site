// Release 467 Build 222 — current read-only reliability projection over exact Build 221 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=222;
export const CURRENT_RELIABILITY_TITLE='Project-to-Knowledge Promotion & Recipe History';
export const CURRENT_RELIABILITY_AUTHORITY='current-development-authority.json';
export const CURRENT_READ_ONLY='CURRENT_READ_ONLY';
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  release:467,build:221,title:'Workshop Knowledge Library Foundation',
  ...
  branch_hygiene_run:35619862154,build_specific_proof_run:35619862180,exact_preview_deployment:true,
...
export const LAST_FULLY_VERIFIED_DEVELOPMENT=Object.freeze({
  ...
  dev_sha:'eceee6897410295b029f08ac728b159cf7559823',tree_sha:'321514649fa70ba2ccdc4961ca69eba08eef6962',
  system_gate_run:35619862172,current_application_quality_run:35619862224,it_admin_runtime_proof_run:35619862189,
  branch_hygiene_run:35619862154,build_specific_proof_run:35619862180,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN'
});
export const CURRENT_PRODUCTION=Object.freeze({
  ...
  products_browser_proof_run:35620434354,products_route_proof_run:35620434404,build_specific_proof_run:35620308104,remote_d1_queries:0
});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:222,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:222,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
      ...
      closure_candidate_requires_external_exact_head_proof:true,build221_workshop_knowledge_library_production_green:true,
      build222_project_knowledge_recipe_history_candidate:true,build222_exact_head_proof_required:true,production_baseline_build:221
    },
