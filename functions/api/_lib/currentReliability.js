// Release 467 Build 250 — current read-only startup/provider read-budget projection over exact Build 249 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=250;
export const CURRENT_RELIABILITY_TITLE='Startup & Provider Read-Budget Verification';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:35945324865,exact_preview_deployment:true,role:'LAST_FULLY_VERIFIED_RESTART_CHECKPOINT'
});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:250,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:250,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
      ...
      build239_navigation_production_green:true,build240_admin_read_budget_production_green:true,successor_builds_planned:'Build 251-256 evidence-driven refinement outcomes roadmap',production_baseline_build:249
    },
