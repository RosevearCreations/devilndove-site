// Release 467 Build 269 — current read-only Private Raw Media Intake Integrity over exact Build 268 Production source.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=269;
export const CURRENT_RELIABILITY_TITLE='Private Raw Media Intake Integrity';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:36176223158,dedicated_gate_run:36176223314,proof_state:'EXACT_BRANCH_HEAD_FIVE_PROOF_GREEN',exact_preview_deployment:true,role:'LAST_FULLY_VERIFIED_RESTART_CHECKPOINT'
});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:269,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:269,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
