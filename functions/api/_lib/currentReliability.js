// Release 467 Build 267 — current read-only CAIP Duplicate & Orphan Recovery Classification over exact Build 266 Production source.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=267;
export const CURRENT_RELIABILITY_TITLE='CAIP Duplicate & Orphan Recovery Classification';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:36156294718,dedicated_gate_run:36156294779,proof_state:'EXACT_BRANCH_HEAD_FIVE_PROOF_GREEN',exact_preview_deployment:true,role:'LAST_FULLY_VERIFIED_RESTART_CHECKPOINT'
});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:267,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:267,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
