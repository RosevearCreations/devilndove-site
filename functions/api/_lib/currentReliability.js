// Release 467 Build 221 — current read-only reliability projection over exact Build 220 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=221;
export const CURRENT_RELIABILITY_TITLE='Workshop Knowledge Library Foundation';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:35606184707,build_specific_proof_run:35606184585,exact_preview_deployment:true,
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    ...
    provenance:{
      current_surface_release:467,current_surface_build:221,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
      ...
      closure_candidate_requires_external_exact_head_proof:true,build220_production_run_qa_rework_scrap_evidence_production_green:true,
      build221_workshop_knowledge_library_candidate:true,build221_exact_head_proof_required:true,production_baseline_build:220
    },
