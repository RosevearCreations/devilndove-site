// Release 467 Build 245 — current read-only API/read-budget refinement over exact Build 240 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=245;
export const CURRENT_RELIABILITY_TITLE='CSP & Browser Injection-Surface Hardening';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:35925164408,exact_preview_deployment:true,role:'LAST_FULLY_VERIFIED_RESTART_CHECKPOINT'
});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    ...
    provenance:{
      current_surface_release:467,current_surface_build:245,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
