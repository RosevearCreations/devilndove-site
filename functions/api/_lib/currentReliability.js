// Release 467 Build 152 — current read-only reliability projection.
import { loadRelease466Reliability } from './release466Reliability.js';
export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=152;
export const CURRENT_RELIABILITY_TITLE='Site-wide Image Quality Scoring & Media QA';
export const CURRENT_RELIABILITY_AUTHORITY='current-development-authority.json';
export const CURRENT_READ_ONLY='CURRENT_READ_ONLY';
export const ACCEPTED_DEVELOPMENT=Object.freeze({release:467,build:152,title:'Site-wide Image Quality Scoring & Media QA',accepted_dev_sha:'1d01cbed98b78543b75dab808a30fb76c20d6060',accepted_dev_tree_sha:'9cf8b0ac918ce567c51536f05d4c89b6f6294765',system_gate_run:34860514075,current_application_quality_run:34860514137,it_admin_runtime_proof_run:34860514304,branch_hygiene_run:34860514150,exact_preview_deployment:true,role:'LAST_FULLY_VERIFIED_RESTART_CHECKPOINT'});
export const LAST_FULLY_VERIFIED_DEVELOPMENT=Object.freeze({release:467,build:152,title:'Site-wide Image Quality Scoring & Media QA',dev_sha:'1d01cbed98b78543b75dab808a30fb76c20d6060',tree_sha:'9cf8b0ac918ce567c51536f05d4c89b6f6294765',system_gate_run:34860514075,current_application_quality_run:34860514137,it_admin_runtime_proof_run:34860514304,branch_hygiene_run:34860514150,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN'});
export const CURRENT_PRODUCTION=Object.freeze({release:467,build:152,title:'Site-wide Image Quality Scoring & Media QA',main_sha:'2f22e280426968a9ff229a0cee9ee62a69dc9d75',tree_sha:'9cf8b0ac918ce567c51536f05d4c89b6f6294765',production_pages_deploy_run:34860809983,production_live_resource_integrity_run:34860922626,state:'PRODUCTION_GREEN'});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:152,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
