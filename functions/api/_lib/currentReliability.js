// Release 467 Build 228 — current read-only route-to-proof pilot over exact Build 227 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=228;
export const CURRENT_RELIABILITY_TITLE='First Real Custom Work Route-to-Proof Pilot';
...
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:35671994205,build_specific_proof_run:35671994164,exact_preview_deployment:true,
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:228,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:228,inherited_engine:'functions/api/_lib/release466Reliability.js',inherited_engine_role:'HISTORICAL_REGRESSION_COMPATIBILITY',
      ...
      closure_candidate_requires_external_exact_head_proof:true,build227_manufacturing_adoption_production_green:true,
      build228_route_to_proof_pilot_candidate:true,build228_schema_migration_added:false,build228_synthetic_business_records:false,
      successor_builds_planned:'229-232',production_baseline_build:227
    },
