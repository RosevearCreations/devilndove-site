// Release 467 Build 211 — current read-only reliability projection over exact Build 210 GREEN predecessor.
import { loadRelease466Reliability } from './release466Reliability.js';

export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=211;
export const CURRENT_RELIABILITY_TITLE='Manufacturing Triage & Route Proposal';
export const CURRENT_RELIABILITY_AUTHORITY='current-development-authority.json';
export const CURRENT_READ_ONLY='CURRENT_READ_ONLY';
export const ACCEPTED_DEVELOPMENT=Object.freeze({
  release:467,build:210,title:'Custom Work Intake 2.0',
  accepted_dev_sha:'228d50a0a71d8b99e24f888b8bcd25b9c839a396',accepted_dev_tree_sha:'f8e85d5e91a9eee5a9c64901865efe24be1ad34e',
  system_gate_run:35519319569,current_application_quality_run:35519319561,it_admin_runtime_proof_run:35519319637,
  branch_hygiene_run:35519319612,build_specific_proof_run:35519319562,exact_preview_deployment:true,
...
export const CURRENT_PRODUCTION=Object.freeze({
  ...
  main_sha:'6e81942e7fd54157698b640252eed256b0411752',tree_sha:'f8e85d5e91a9eee5a9c64901865efe24be1ad34e',
  production_pages_deploy_run:35519559453,production_live_resource_integrity_run:35519611667,
  products_browser_proof_run:35519611679,products_route_proof_run:35519611767,
  build_specific_proof_run:35519559362,remote_d1_queries:0
});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:211,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
    ...
    provenance:{
      current_surface_release:467,current_surface_build:211,
      ...
      build210_custom_work_intake_production_green:true,build211_manufacturing_triage_candidate:true,build211_exact_head_proof_required:true,production_baseline_build:210
    },
    safety:{
