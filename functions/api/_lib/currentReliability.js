// Release 467 Build 150 — current read-only reliability projection.
import { loadRelease466Reliability } from './release466Reliability.js';
export const CURRENT_RELIABILITY_RELEASE=467;
export const CURRENT_RELIABILITY_BUILD=150;
export const CURRENT_RELIABILITY_TITLE='Orders, Fulfillment & Buyer Communication Workspace';
export const CURRENT_RELIABILITY_AUTHORITY='current-development-authority.json';
export const CURRENT_READ_ONLY='CURRENT_READ_ONLY';
export const ACCEPTED_DEVELOPMENT=Object.freeze({release:467,build:150,title:'Orders, Fulfillment & Buyer Communication Workspace',accepted_dev_sha:'33d46f701adb839525561114a31abcd29943d28f',accepted_dev_tree_sha:'2f7add90d513a2e9548865f04d97e69b0ae3630e',system_gate_run:34802545653,current_application_quality_run:34802545673,it_admin_runtime_proof_run:34802545668,branch_hygiene_run:34802545660,exact_preview_deployment:true,role:'LAST_FULLY_VERIFIED_RESTART_CHECKPOINT'});
export const LAST_FULLY_VERIFIED_DEVELOPMENT=Object.freeze({release:467,build:150,title:'Orders, Fulfillment & Buyer Communication Workspace',dev_sha:'33d46f701adb839525561114a31abcd29943d28f',tree_sha:'2f7add90d513a2e9548865f04d97e69b0ae3630e',system_gate_run:34802545653,current_application_quality_run:34802545673,it_admin_runtime_proof_run:34802545668,branch_hygiene_run:34802545660,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN'});
export const CURRENT_PRODUCTION=Object.freeze({release:467,build:150,title:'Orders, Fulfillment & Buyer Communication Workspace',main_sha:'531e303d32d426d2db6986ec5c3d466455612ee3',tree_sha:'2f7add90d513a2e9548865f04d97e69b0ae3630e',production_pages_deploy_run:34802707901,production_live_resource_integrity_run:34802759988,state:'PRODUCTION_GREEN'});
...
export async function loadCurrentReliability(db,env={}){
  ...
  return {
    release:467,build:150,title:CURRENT_RELIABILITY_TITLE,authority:CURRENT_RELIABILITY_AUTHORITY,state:CURRENT_READ_ONLY,
