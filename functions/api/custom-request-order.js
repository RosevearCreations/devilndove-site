...
export async function onRequestGet(context) {
  ...
  return json({ ok: true, order, items, stages, photos, proof_consent, link: { link_status: link.link_status || 'active', custom_request_id: Number(link.custom_request_id || 0) || null, order_stage: link.order_stage || 'planning', stage_notes: link.stage_notes || '', stage_updated_at: link.stage_updated_at || '' } });
}
