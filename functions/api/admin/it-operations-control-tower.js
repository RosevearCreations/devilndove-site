...
const ACCEPTED_DEVELOPMENT = Object.freeze({
  ...
  accepted_sha: 'addcb5533d3a53465bb9d4ae8398952b8836ccc4',
  accepted_tree_sha: '92b80e37385186343d20aae9c4453d9db3f94ca1',
  system_gate_run: 33887320361,
  current_application_quality_run: 33887320336,
  it_admin_runtime_proof_run: 33887320333,
  branch_hygiene_run: 33887320328,
});
...
export async function onRequestGet(context) {
  ...
  return jsonResponse({
    ...
    title: TITLE,
    ok: true,
    authority: 'release467-build40-product-social-automation-runtime-ddl-elimination',
    state: 'DEVELOPMENT_GREEN',
    ...
    release_authority: {
      ...
      reliability_projection_build: 40,
      ...
      deployment_preflight_projection_build: 40,
    ...
    truth_notes: [
      'Build 40 is Development GREEN and owns current I.T. operator truth.',
      'Product Social Automation carries zero request-time schema DDL and asserts the proven product_social_automation_settings and social_post_queue baselines read-only before settings or review-first queue business DML proceeds.',
      'Missing Product Social schema fails closed with product_social_automation_schema_not_ready; runtime schema repair remains disabled.',
      'Historical runtime schema residue is ratcheted to ceilings of 58 files, 522 DDL statements and 2 delegated/shared helpers, with zero raw D1 bypasses carrying DDL.',
      'Accounting and Product Numbering remain pinned at zero request-time schema DDL under their Build 38 and Build 39 authorities.',
      'The canonical D1 migration stream remains exactly four files; Build 40 adds no migration because both Product Social tables are proven pre-canonical baselines.',
      'Deployment Preflight and Reliability are synchronized to Release 467 Build 40 as read-only current projections; their Build 37 and Build 36 feature authorities remain historical evidence.',
      'Build 39 remains the historical Product Numbering feature authority and Build 38 remains the historical Accounting feature authority.',
