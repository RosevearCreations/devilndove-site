...
export async function onRequestGet(context) {
  ...
  return jsonResponse({
    ...
    release_authority: {
      current_operator: { release: RELEASE, build: BUILD, title: TITLE, state: 'DEVELOPMENT_GREEN' }, accepted_development: ACCEPTED_DEVELOPMENT, production: PRODUCTION,
    ...
    truth_notes: [
      'Build 48 is Development GREEN and owns current I.T. operator truth.',
      ...
      'Build 48 checks approved reviewer evidence, exact story-to-clip evidence coverage, source bounds, contiguous timeline timing, confirmed camera synchronization offsets, supported aspect ratio and target duration.',
      ...
      'The canonical D1 stream remains exactly four files and request-time schema DDL remains zero for Builds 38-48 current protected authorities.',
      'Deployment Preflight and Reliability are synchronized to Release 467 Build 48 as read-only current projections; Build 37 and Build 36 remain historical feature evidence.',
      ...
      'No Build 49 scope is currently approved; the roadmap remains intentionally open after final Build 48 closure.',
      'External HOLDs never become GREEN by inference from Build 48 source/deployment acceptance.'
    ],
