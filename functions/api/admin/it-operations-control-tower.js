...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 279 Canonical Restart Evidence Pack
...
- Current Production baseline: Build 278 Authenticated Private Review & Range-Streaming Acceptance Refresh
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:279,title:TITLE,authority:'release467-build279-multipart-interruption-resume-acceptance-drill.json'},
