...
const ACCEPTED_DEVELOPMENT = Object.freeze({
  ...
  accepted_sha: '091fe5b7c3311bb9fb1bc54218be16952d999e7e',
  accepted_tree_sha: '9b6f28c4d4963e398adda8e59b2ccf3a8c4167aa',
  system_gate_run: 33916429890,
  current_application_quality_run: 33916429943,
  it_admin_runtime_proof_run: 33916429939,
  branch_hygiene_run: 33916430024,
});
...
export async function onRequestGet(context) {
  ...
  return jsonResponse({
    ...
    title: TITLE,
    ok: true,
    authority: 'release467-build47-ai-story-edit-planning',
    state: 'DEVELOPMENT_GREEN',
    ...
    release_authority: {
      ...
      reliability_projection_build: 47,
      ...
      deployment_preflight_projection_build: 47,
      ...
      packaging_label_production_authority: 'release467-build44-label-production-reuse',
      packaging_label_production_gate: 'scripts/current_packaging_label_production_gate.py',
      packaging_label_production_request_time_ddl: 0,
      grey_hair_media_intelligence_authority: 'release467-build45-grey-hair-media-intelligence',
      grey_hair_media_intelligence_gate: 'scripts/current_grey_hair_media_intelligence_gate.py',
      grey_hair_media_intelligence_request_time_ddl: 0,
      grey_hair_sync_alignment_authority: 'release467-build46-four-camera-sync-audio-alignment',
      grey_hair_sync_alignment_gate: 'scripts/current_grey_hair_sync_alignment_gate.py',
      grey_hair_sync_alignment_request_time_ddl: 0,
      grey_hair_story_edit_planning_authority: 'release467-build47-ai-story-edit-planning',
      grey_hair_story_edit_planning_gate: 'scripts/current_grey_hair_story_edit_planning_gate.py',
      grey_hair_story_edit_planning_request_time_ddl: 0,
    ...
    truth_notes: [
      'Build 47 is Development GREEN and owns current I.T. operator truth.',
      ...
      'Build 47 reuses existing CAIP story-builder and edit-timeline authorities and adds no competing schema or canonical migration.',
      'Build 47 consumes only approved source-backed evidence from one confirmed Build 46 four-camera group.',
      'Generated story plans remain draft until explicit human review or approval; edit planning is blocked until that review occurs.',
      'Story beats retain evidence provenance and timeline clips retain source timing, camera labels, captions and confirmed synchronization offsets.',
      'Target-duration overflow is surfaced for review rather than silently dropping approved source beats.',
      'Source originals remain private and immutable; raw public R2 URLs, external AI/provider execution, media rendering, publication and R2 mutation remain disabled.',
      ...
      'Build 47 adds no schema or canonical migration and performs zero request-time DDL; the canonical D1 stream remains exactly four files.',
      ...
      'Deployment Preflight and Reliability are synchronized to Release 467 Build 47 as read-only current projections; their Build 37 and Build 36 feature authorities remain historical evidence.',
      ...
      'Build 48 may begin only after the Build 47 authority descendant independently passes the final four-proof Development closure cycle.',
