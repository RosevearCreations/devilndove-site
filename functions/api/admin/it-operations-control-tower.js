...
export async function onRequestGet(context){
  ...
  const data={
    ...
    release_efficiency_read_budget_outcome_verification:{accepted_heads:12,total_workflow_runs:596,successful_runs:584,failed_runs:9,skipped_runs:3,runs_per_head:49.666667,normalized_runs_per_head_reduction_percent:20.0766,required_named_proofs_green:true,exact_tree_continuity:true,historical_noncanonical_failure_workflow:'Release 467 Build 155 Products Development Browser Proof',historical_noncanonical_failure_count:9,build255_closure_runs:134,build262_closure_runs:68,build255_to_build262_reduction_percent:49.2537,candidate_workflow_files:153,pull_request:39,push:127,workflow_dispatch:135,workflow_run:5,expected_today_tasks_statements:8,today_tasks_rows_read_ceiling:15000,seller_daily_rows_read_ceiling:10000,aggregate_rows_read_ceiling:25000,production_d1_contact:false,next_build:264,future_queue_exhausted:false},
    ...
    truth_notes:[
      ...
      'Build 263 measures 596 runs across 12 accepted heads, a 20.08% normalized runs-per-head reduction while all required named proofs and exact-tree release pairs remain valid.',
