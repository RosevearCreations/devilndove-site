// Release 467 Build 242 — current release/restart authority over exact Build 240 GREEN predecessor.
...
const RELEASE=467;
const BUILD=242;
const TITLE='Release, Diagnostics & Evidence Streamlining';
const AUTHORITY='release467-build242-release-diagnostics-evidence-streamlining';
const EVIDENCE_ID='r467-b240-b239-35880685343-35881116063';

const VERIFIED_DEVELOPMENT=Object.freeze({
  release:467,build:241,title:'Cross-Authority Handoff Simplification',state:'DEVELOPMENT_GREEN',
  ...
  branch_hygiene_run:35880685361,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN',
...
const CURRENT_GUARDS=Object.freeze([
  ...
  'Release 467 Build 242 API Read Budget Cache Batch Streamlining'
]);
...
function closurePayload(){
  return {
    ...
    development_proofs:{
      system_gate_run:35880685343,current_application_quality_run:35880685733,
      it_admin_runtime_proof_run:35880685713,branch_hygiene_run:35880685361
    },
    production_proofs:{
      production_pages_deploy_run:35881116063,production_live_resource_integrity_run:35881253740,
      products_browser_proof_run:35881253749,products_route_proof_run:35881253783
    },
...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 242 Canonical Restart Evidence Pack
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:240,title:TITLE,authority:'release467-build242-release-diagnostics-evidence-streamlining.json'},
    ...
    truth_notes:[
      ...
      'Build 240 Production is GREEN on the identical tree b9d600e5eed18fe6697f42cf1588717437d4f725.',
