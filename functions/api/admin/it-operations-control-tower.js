...
const ACCEPTED_DEVELOPMENT = Object.freeze({
  ...
  accepted_sha: '77bd11541095358d21dc18b98270f00d00242f7f',
  accepted_tree_sha: '0127bc8558e8f37a886c33bddb8a295f6aaa32d9',
  system_gate_run: 33912776513,
  current_application_quality_run: 33912776473,
  it_admin_runtime_proof_run: 33912776406,
  branch_hygiene_run: 33912776442,
});
...
export async function onRequestGet(context) {
  ...
  return jsonResponse({
    ...
    title: TITLE,
    ok: true,
    authority: 'release467-build45-grey-hair-media-intelligence',
    state: 'DEVELOPMENT_GREEN',
    ...
    release_authority: {
      ...
      reliability_projection_build: 45,
      ...
      deployment_preflight_projection_build: 45,
    ...
    truth_notes: [
      'Build 45 is Development GREEN and owns current I.T. operator truth.',
      'Grey Hair Media Intelligence is a private read-only convergence over existing CAIP assets, technical observations, temporal evidence, transcript excerpts, processing jobs and verified processing artifacts.',
      'Build 45 source originals remain private and immutable; raw public R2 URLs, provider execution, publication and R2 mutation are disabled.',
      'Build 46 owns four-camera synchronization and audio alignment; Build 47 owns AI story/edit automation.',
      ...
      'Build 45 adds no schema or canonical migration and performs zero request-time DDL; the canonical D1 stream remains exactly four files.',
      ...
      'Deployment Preflight and Reliability are synchronized to Release 467 Build 45 as read-only current projections; their Build 37 and Build 36 feature authorities remain historical evidence.',
      ...
      'Build 46 may begin only after the Build 45 authority descendant independently passes the final four-proof Development closure cycle.',
