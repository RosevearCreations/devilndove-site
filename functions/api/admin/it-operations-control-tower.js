// Release 467 Build 235 — current release/restart authority over exact Build 234 GREEN predecessor.
...
const AUTHORITY='release467-build235-resume-work-cross-workspace-handoff';
const EVIDENCE_ID='r467-b234-b235-35798441644-35798690001';
...
function closurePayload(){
  return {
    ...
    development_proofs:{
      system_gate_run:35798441644,current_application_quality_run:35798441665,
      it_admin_runtime_proof_run:35798441497,branch_hygiene_run:35798441629
    },
    production_proofs:{
      production_pages_deploy_run:35798690001,production_live_resource_integrity_run:35798742625,
    ...
    next_build:'Build 235 is the active owner-authorized refinement candidate; Build 236 follows only after exact Build 235 Production GREEN.'
  };
}
...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 234 Canonical Restart Evidence Pack
...
- Current candidate: Build 235 Resume Work & Cross-Workspace Handoff
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:235,title:TITLE,authority:'release467-build235-resume-work-cross-workspace-handoff.json'},
    ...
    truth_notes:[
      'Build 234 source is the exact last fully verified Development checkpoint.',
      'Build 234 Production is GREEN on the identical source tree; Build 235 adds a navigation-only resume/handoff layer over existing authorities.',
      ...
      'Build 235 Resume Work & Cross-Workspace Handoff is the active Development candidate.',
      'Build 235 is navigation-only, adds no schema change or business/provider mutation, and Production remains closed until exact-head proof.'
    ],
    safety:{
