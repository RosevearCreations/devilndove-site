// Release 467 Build 243 — current release/restart authority over exact Build 240 GREEN predecessor.
...
const RELEASE=467;
const BUILD=243;
const TITLE='Session Architecture Hardening';
const AUTHORITY='release467-build243-session-architecture-hardening';
const EVIDENCE_ID='r467-b240-b239-35883357799-35883719199';

const VERIFIED_DEVELOPMENT=Object.freeze({
  release:467,build:242,title:'Release, Diagnostics & Evidence Streamlining',state:'DEVELOPMENT_GREEN',
  ...
  branch_hygiene_run:35883357974,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN',
...
const CURRENT_GUARDS=Object.freeze([
  ...
  'Release 467 Build 243 API Read Budget Cache Batch Streamlining'
]);
...
function closurePayload(){
  return {
    ...
    development_proofs:{
      system_gate_run:35883357799,current_application_quality_run:35883358653,
      it_admin_runtime_proof_run:35883357777,branch_hygiene_run:35883357974
    },
    production_proofs:{
      production_pages_deploy_run:35883719199,production_live_resource_integrity_run:35883846712,
      products_browser_proof_run:35883846744,products_route_proof_run:35883846755
    },
...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 243 Canonical Restart Evidence Pack
...
- Current candidate: Build 241 Release, Diagnostics & Evidence Streamlining
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:240,title:TITLE,authority:'release467-build243-session-architecture-hardening.json'},
    ...
    truth_notes:[
      ...
      'Build 240 Production is GREEN on the identical tree 3ea103b093c4dcbf1670346dcce0ec6acf214470.',
      ...
      'Build 241 Session Architecture Hardening is the active Development candidate and contains the reported Admin lockup.',
