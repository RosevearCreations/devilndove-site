// Release 467 Build 219 — current release/restart authority over exact Build 218 GREEN predecessor.
...
const AUTHORITY='release467-build219-manufacturing-work-order-job-traveler';
const EVIDENCE_ID='r467-b218-068b99a9-35556952902-35557094198';
...
const PRODUCTION=Object.freeze({
  ...
  main_sha:'24b59add984ea0be5acc3ebe3bf8ae558db747ee',
  tree_sha:'0bb22258a030eb529be3a7b5faf9ba12baa66f46',pages_deploy_run:35557094198,production_pages_deploy_run:35557094198,
  production_live_resource_integrity_run:35557137931,products_browser_proof_run:35557137831,
  products_route_proof_run:35557137932,build_specific_proof_run:35557094182,remote_d1_queries:0,
  exact_production_url:'https://b8567968.devilndove-site.pages.dev'
});
...
const CURRENT_GUARDS=Object.freeze([
  ...
  'Release 467 Build 218 Quote Production Cost Margin Guardrails Proof'
]);
...
function closurePayload(){
  return {
    ...
    development_proofs:{
      system_gate_run:35556952902,current_application_quality_run:35556952735,
      it_admin_runtime_proof_run:35556952815,branch_hygiene_run:35556952797,build218_proof_run:35556952722
    },
    production_proofs:{
      production_pages_deploy_run:35557094198,production_live_resource_integrity_run:35557137931,
      products_browser_proof_run:35557137831,products_route_proof_run:35557137932,build218_proof_run:35557094182
    },
    ...
    runtime_closure:{
      ...
      background_polling:false,automatic_inventory_assignment:false,build218_quote_production_cost_margin_guardrails:true
    },
    next_build:'Build 219 adds versioned reviewed Manufacturing Work Order & Job Traveler evidence over exact Build 218 proof.'
  };
}
...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 218 Canonical Restart Evidence Pack
...
- System Gate: 35556952902
- Current Application Quality Proof: 35556952735
- I.T. Admin Runtime Proof: 35556952815
- Repository Branch Hygiene: 35556952797
- Build 217 Development Proof: 35556952722
- Production Pages Deploy: 35557094198
- Production Live Resource Integrity: 35557137931
- Build 217 Production Proof: 35557094182
- Current candidate: Build 219 Manufacturing Work Order & Job Traveler
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:219,title:TITLE,authority:'release467-build219-manufacturing-work-order-job-traveler.json'},
    ...
    truth_notes:[
      'Build 218 source is the exact last fully verified Development checkpoint.',
      'Build 218 Production is GREEN on the identical source tree through canonical migration 0017.',
      'Development proofs: System 35556952902, Quality 35556952735, I.T. 35556952815, Hygiene 35556952797.',
      'Production proofs: Pages 35557094198, Live Resources 35557137931, Product Browser 35557137831, Product Route 35557137932.',
      'Build 219 Manufacturing Work Order & Job Traveler is the active Development closure candidate.',
      'Canonical D1 migrations advance through 0001-0018 for Build 219 traveler evidence.'
    ],
    safety:{
