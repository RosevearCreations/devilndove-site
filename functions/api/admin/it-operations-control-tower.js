// Release 467 Build 213 — current release/restart authority over exact Build 212 GREEN predecessor.
...
const AUTHORITY='release467-build213-digital-proof-customer-approval';
const EVIDENCE_ID='r467-b212-7891a869-35526209718-35526432043';
...
const PRODUCTION=Object.freeze({
  ...
  tree_sha:'f972119d10f98ea566173868915463ce31cdf22c',pages_deploy_run:35526432043,production_pages_deploy_run:35526432043,
...
function closurePayload(){
  return {
    ...
    development_proofs:{
      system_gate_run:35526209718,current_application_quality_run:35526209719,
      it_admin_runtime_proof_run:35526209723,branch_hygiene_run:35526209630,build212_proof_run:35526209730
    },
    production_proofs:{
      production_pages_deploy_run:35526432043,production_live_resource_integrity_run:35526530121,
      products_browser_proof_run:35526530105,products_route_proof_run:35526530131,build212_proof_run:35526432021
    },
    ...
    canonical_migrations:CANONICAL_MIGRATIONS.slice(0,12),
    ...
    runtime_closure:{
      ...
      background_polling:false,automatic_inventory_assignment:false,build212_hybrid_creative_operations:true
    },
    next_build:'Build 213 adds versioned private customer proof/approval through canonical migration 0013 over exact Build 212 proof.'
  };
}
...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 212 Canonical Restart Evidence Pack
...
- System Gate: 35526209718
- Current Application Quality Proof: 35526209719
- I.T. Admin Runtime Proof: 35526209723
- Repository Branch Hygiene: 35526209630
- Build 212 Development Proof: 35526209730
- Production Pages Deploy: 35526432043
- Production Live Resource Integrity: 35526530121
- Build 212 Production Proof: 35526432021
- Current candidate: Build 213 Digital Proof & Customer Approval
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:213,title:TITLE,authority:'release467-build213-digital-proof-customer-approval.json'},
    ...
    truth_notes:[
      'Build 212 source is the exact last fully verified Development checkpoint.',
      'Build 212 Production is GREEN on the identical source tree with canonical migration 0012 applied.',
      'Development proofs: System 35526209718, Quality 35526209719, I.T. 35526209723, Hygiene 35526209630.',
      'Production proofs: Pages 35526432043, Live Resources 35526530121, Product Browser 35526530105, Product Route 35526530131.',
      'Build 213 Digital Proof & Customer Approval is the active Development closure candidate.',
      'Canonical D1 migrations are now 0001-0013 in source; migration 0013 must be applied/proven in Development before promotion.'
    ],
    safety:{
