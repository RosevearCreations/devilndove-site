// Release 467 Build 237 — current release/restart authority over exact Build 234 GREEN predecessor.
...
const AUTHORITY='release467-build237-mobile-touch-keyboard-dense-workspace-ergonomics';
const EVIDENCE_ID='r467-b235-b236-35857576835-35857748748';
...
const CURRENT_GUARDS=Object.freeze([
  ...
  'Release 467 Build 237 Save Confidence Unsaved-Work Safe Batch Review'
]);
...
function closurePayload(){
  return {
    ...
    development_proofs:{
      system_gate_run:35857576835,current_application_quality_run:35857576801,
      it_admin_runtime_proof_run:35857576924,branch_hygiene_run:35857576861
    },
    production_proofs:{
      production_pages_deploy_run:35857748748,production_live_resource_integrity_run:35857829165,
    ...
    next_build:'Build 237 is the active owner-authorized refinement candidate; Build 238 follows only after exact Build 237 Production GREEN.'
  };
}
...
function markdownReport(pack){
  return `# Devil n Dove Release 467 Build 236 Canonical Restart Evidence Pack
...
- Current candidate: Build 236 Mobile, Touch, Keyboard & Dense-Workspace Ergonomics
  ...
  const data={
    ...
    release_authority:{
      ...
      restart_integrity:{
        ...
        current_closure_candidate:{release:467,build:237,title:TITLE,authority:'release467-build237-mobile-touch-keyboard-dense-workspace-ergonomics.json'},
    ...
    truth_notes:[
      'Build 236 source is the exact last fully verified Development checkpoint.',
      ...
      'Build 236 Mobile, Touch, Keyboard & Dense-Workspace Ergonomics is the active Development candidate.',
