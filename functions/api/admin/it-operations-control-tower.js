...
const ACCEPTED_DEVELOPMENT = Object.freeze({
  ...
  accepted_sha: 'f72de937342f4d213243f35a278429be078df85d',
  accepted_tree_sha: 'd0eefd5362b167fd01602205915b6966b080af61',
  system_gate_run: 33914234895,
  current_application_quality_run: 33914234888,
  it_admin_runtime_proof_run: 33914234944,
  branch_hygiene_run: 33914234946,
});
...
export async function onRequestGet(context) {
  ...
  return jsonResponse({
    ...
    title: TITLE,
    ok: true,
    authority: 'release467-build46-four-camera-sync-audio-alignment',
    state: 'DEVELOPMENT_GREEN',
    ...
    release_authority: {
      ...
      reliability_projection_build: 46,
      ...
      deployment_preflight_projection_build: 46,
    ...
    truth_notes: [
      'Build 46 is Development GREEN and owns current I.T. operator truth.',
      'Build 45 Grey Hair Media Intelligence remains the reviewed private-media input authority for Build 46.',
      'Build 46 reuses existing CAIP capture-group/track authorities for exactly four distinct Build-45-ready private camera sources plus at most one separate private audio source.',
      'Build 46 persists reviewed millisecond offsets, confidence, method and notes, and cannot confirm a group until all included tracks satisfy the review boundary.',
      'Source originals remain private and immutable; raw public R2 URLs, waveform/media processing, provider execution, publication and R2 mutation remain disabled.',
      ...
      'Build 46 adds no schema or canonical migration and performs zero request-time DDL; the canonical D1 stream remains exactly four files.',
      ...
      'Deployment Preflight and Reliability are synchronized to Release 467 Build 46 as read-only current projections; their Build 37 and Build 36 feature authorities remain historical evidence.',
      ...
      'Build 47 may begin only after the Build 46 authority descendant independently passes the final four-proof Development closure cycle.',
