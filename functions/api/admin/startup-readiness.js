...
// Build 229 — complete blocker register with adopted packaging references and a distinct missing-image launch gate.
...
const STARTUP_ITEMS = [
  {
    ...
    "external": "Build 229 archive, current schema/migration files, Cloudflare Pages Functions bundler, and PRELAUNCH_PROCESS_PLAYBOOKS.md",
    ...
    "pass": "The exact Build 229 archive passes every static, schema, syntax, CSS, one-H1, metadata, fallback, packaging-reference, documentation and Pages Functions bundle check with zero unresolved blocker."
  },
  {
    ...
    "pass": "A recoverable D1 point exists, the Build 229 migration is applied once after Build 228, the complete deployment is live, all 43 gates load, all three packaging source records exist, and no migration, Function, route or data-integrity error remains."
  },
  {
  ...
  },
  {
    ...
    "pass": "Every sensitive action is enforced on the server, lower roles receive 401/403, and successful actions are attributable in the audit history."
  },
  {
    ...
    "pass": "Expected failures are visible, sanitized, recoverable, and recorded; fallback states never present an uncompleted business action as successful."
  },
  {
...
const GATE_FIX_FOCUS = {
  ...
  missing_launch_images:'complete the IMAGES_REQUIRED manifest, replace every missing/broken/fallback/planning asset with rights-cleared final media, and retest all launch routes on phone and desktop',
