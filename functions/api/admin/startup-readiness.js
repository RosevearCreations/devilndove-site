...
// Build 241 — complete blocker register plus CAIP private raw-media intake, Operational Continuity and retained bounded login/session proof.
...
const STARTUP_ITEMS = [
  {
    ...
    "external": "Build 241 archive, current schema/migration files, Cloudflare Pages Functions bundler, and PRELAUNCH_PROCESS_PLAYBOOKS.md",
    ...
    "pass": "The exact Build 241 archive passes every static, bounded-login/session-retention, autosave/reload, archived-product removal, schema, syntax, CSS, one-H1, metadata, image-manifest, fallback, packaging-reference, documentation and Pages Functions bundle check with zero unresolved blocker."
  },
  {
    ...
    "pass": "A recoverable D1 point exists, the Build 241 migration is applied once after the required prior ledger keys, the complete deployment is live, all 46 gates, five packaging references, five new reusable templates and 20 manifest rows load, and no migration, Function, route or data-integrity error remains."
  },
  {
...
const GATE_FIX_FOCUS = {
  ...
  caip_private_large_media_intake:'keep the raw-media workflow private and unapproved, correct the private R2 binding/upload-session/part/checksum/governance failure, resume or restart only the affected unfinished upload, verify the immutable raw object and D1 metadata chain, then repeat the processing-plan and public-promotion review without exposing the private original',
  operational_continuity_evidence_center:'keep the affected workstream open or blocked, record the exact missing evidence or duplicate/fallback failure, correct the authoritative workflow, then repeat the full case and attach safe evidence',
