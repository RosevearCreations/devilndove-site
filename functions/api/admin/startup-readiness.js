...
// Build 230 — complete blocker register with a database-backed visual image manifest.
...
const STARTUP_ITEMS = [
  {
    ...
    "external": "Build 230 archive, current schema/migration files, Cloudflare Pages Functions bundler, and PRELAUNCH_PROCESS_PLAYBOOKS.md",
    ...
    "pass": "The exact Build 230 archive passes every static, schema, syntax, CSS, one-H1, metadata, image-manifest, fallback, packaging-reference, documentation and Pages Functions bundle check with zero unresolved blocker."
  },
  {
