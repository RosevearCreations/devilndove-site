...
// Build 231 — complete blocker register plus product autosave/reload resource-limit proof.
...
const STARTUP_ITEMS = [
  {
    ...
    "external": "Build 231 archive, current schema/migration files, Cloudflare Pages Functions bundler, and PRELAUNCH_PROCESS_PLAYBOOKS.md",
    ...
    "pass": "The exact Build 231 archive passes every static, autosave/reload, schema, syntax, CSS, one-H1, metadata, image-manifest, fallback, packaging-reference, documentation and Pages Functions bundle check with zero unresolved blocker."
  },
  {
