...
// Build 240 — complete blocker register plus Operational Continuity and retained bounded login/session proof.
...
const STARTUP_ITEMS = [
  {
    ...
    "external": "Build 240 archive, current schema/migration files, Cloudflare Pages Functions bundler, and PRELAUNCH_PROCESS_PLAYBOOKS.md",
    ...
    "pass": "The exact Build 240 archive passes every static, bounded-login/session-retention, autosave/reload, archived-product removal, schema, syntax, CSS, one-H1, metadata, image-manifest, fallback, packaging-reference, documentation and Pages Functions bundle check with zero unresolved blocker."
  },
  {
    ...
    "pass": "A recoverable D1 point exists, the Build 240 migration is applied once after the required prior ledger keys, the complete deployment is live, all 45 gates, five packaging references, five new reusable templates and 20 manifest rows load, and no migration, Function, route or data-integrity error remains."
  },
  {
  ...
  },
  {
    ...
    "phase": "operations",
    "phase_label": "Recovery, fulfilment, and controlled opening",
    "title": "Operate the Build 240 evidence, continuity, fallback and mobile control centre",
    "order": 357,
    "severity": "critical",
    "live": 1,
