...
// Build 232 — complete blocker register plus bounded archived-product removal proof.
...
const STARTUP_ITEMS = [
  {
    ...
    "external": "Build 232 archive, current schema/migration files, Cloudflare Pages Functions bundler, and PRELAUNCH_PROCESS_PLAYBOOKS.md",
    ...
    "pass": "The exact Build 232 archive passes every static, autosave/reload, archived-product removal, schema, syntax, CSS, one-H1, metadata, image-manifest, fallback, packaging-reference, documentation and Pages Functions bundle check with zero unresolved blocker."
  },
  {
