...
export async function onRequestGet(context){
  ...
  try{
    ...
    return json({ok:true,build:BUILD,...await listData(a.db),detail:projectId?await loadDetail(a.db,projectId):null,mode:'structured_svg_review_first_normalized_soap_labels'});
  }catch(error){
