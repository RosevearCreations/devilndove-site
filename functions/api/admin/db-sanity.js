...
const EXPECTED_TABLES = {
  ...
  accounting_reconciliation_reviews: ['accounting_reconciliation_review_id', 'reconciliation_type', 'period_month', 'scope_key', 'review_status', 'statement_reference', 'difference_reason', 'detail_json', 'attachment_count'],
  accounting_attachments: ['accounting_attachment_id', 'attachment_kind', 'object_key', 'mime_type', 'file_size_bytes'],
