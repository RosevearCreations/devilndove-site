...
const VERIFIED_DEVELOPMENT=Object.freeze({
  ...
  branch_hygiene_run:36031272718,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN',exact_preview_deployment:true
});
...
export async function onRequestGet(context){
  ...
  const checks=[
    ...
    {status:'pass',code:'build251_verified_baseline',label:'Build 251 verified restart baseline',detail:'Build 251 CSP Style Injection-Surface Hardening is exact-tree Development and Production GREEN.'},
