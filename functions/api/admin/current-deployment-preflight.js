// Release 467 Build 193 — current read-only Deployment Preflight over exact Build 192 GREEN baseline.
...
const PRODUCTION=Object.freeze({
  release:467,build:192,state:'PRODUCTION_GREEN',main_sha:'451ca8173b9ad3127f84f352ed0a8d7774e53b14',
  tree_sha:'5752f7e0be8c432d2cc45b5de08c349208ee497a',production_pages_deploy_run:35418692246,
  production_live_resource_integrity_run:35418731807,products_browser_proof_run:35418731822,
  products_route_proof_run:35418731793,build_specific_proof_run:35418692245,remote_d1_queries:0
});
...
export async function onRequestGet(context){
  ...
  const checks=[
    ...
    {status:'pass',code:'build192_verified_baseline',label:'Build 192 verified baseline',detail:'Exact Build 192 Development and Production Pages/live-resource/Product proofs are GREEN.'},
    {status:'review',code:'build193_authority_convergence',label:'Build 193 current authority convergence',detail:'Machine pointer, I.T. truth and canonical human handoff must pass one exact-head Development proof before promotion.'}
  ];
  ...
  const data={
    ...
    release_authority:{
      ...
      current_candidate:{release:467,build:193,title:TITLE,authority:'release467-build193-current-authority-handoff-convergence.json'},
    ...
    truth_notes:[
      `Build 192 is the exact fully verified Development baseline at ${VERIFIED_DEVELOPMENT.dev_sha}; Production source is ${PRODUCTION.main_sha}; both share ${VERIFIED_DEVELOPMENT.tree_sha}.`,
