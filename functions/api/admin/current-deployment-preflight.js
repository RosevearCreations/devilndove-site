...
export async function onRequestGet(context) {
  ...
  const data = {
    ...
    release_authority: { current_release: RELEASE, current_build: BUILD, required_development_proofs: REQUIRED_DEVELOPMENT_PROOFS, production: PRODUCTION, rollback_readiness: 'release-neutral-read-only', historical_feature_authority: 'release467-build37-deployment-preflight-canonical-migration.json' },
    truth_notes: [
      'The active Deployment Preflight is a current read-only Release 467 Build 48 projection.',
      ...
      'Build 45 remains private-media intelligence, Build 46 confirmed synchronization and Build 47 reviewed story/edit planning authority.',
      'Build 48 is GET-only automated production acceptance over approved Build 47 planning and does not create a competing persistence model.',
      'Acceptance requires approved story and timeline reviewer evidence, exact story-to-clip evidence coverage, valid source bounds, contiguous timing, confirmed camera offsets and target-duration compliance.',
      ...
      'No Build 49 scope is approved yet.',
