// Release 467 Build 44 — current Deployment Preflight canonical migration projection.
...
export async function onRequestGet(context) {
  ...
  const data = {
    ...
    truth_notes: [
      'The active Deployment Preflight is a current read-only Release 467 Build 44 projection.',
      ...
      'Build 44 adds no canonical migration and no request-time DDL; the stream remains exactly 0001-0004.',
      'Label Production & Reuse converges existing printer profiles, immutable project versions, export history and physical print-test history through a read-only production readiness authority.',
      'Reusable production versions require approved immutable SVG content, exact 100 percent production scale and matching passed physical QA.',
      'Build 43 label composition and Build 41 printable safe-area enforcement remain mandatory print-time dependencies; Build 42 Material Template Intelligence remains the inherited material authority.',
