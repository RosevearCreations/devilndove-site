// Release 467 Build 171 — current Deployment Preflight over exact Build 170 GREEN baseline.
...
const RELEASE=467;
const BUILD=171;
const TITLE='Release & Restart Authority Convergence';
const CANONICAL_MIGRATIONS=Object.freeze(["0001_release464_migration_authority.sql","0002_release464_operational_acceptance.sql","0003_release464_business_growth.sql","0004_release465_storefront_quality.sql","0005_release467_inventory_process_assignment.sql","0006_release467_product_media_publication_guard.sql"]);
const REQUIRED_DEVELOPMENT_PROOFS=Object.freeze(['System Gate','Current Application Quality Proof','I.T. Admin Runtime Proof','Repository Branch Hygiene','Release 467 Build 171 Release Restart Authority Convergence Proof']);
const VERIFIED_DEVELOPMENT=Object.freeze({release:467,build:170,title:'Product Browser Explicit Image Recovery',dev_sha:'879c8730040afaf6caec6374b5057b7261fdcfe2',tree_sha:'da5e3b249d6e14266da5e191cb22c06205947948',system_gate_run:35275441340,current_application_quality_run:35275441446,it_admin_runtime_proof_run:35275441412,branch_hygiene_run:35275441448,build_specific_proof_run:35275441460,proof_state:'EXACT_BRANCH_HEAD_FOUR_PROOF_GREEN',exact_preview_deployment:true});
const PRODUCTION=Object.freeze({release:467,build:170,state:'PRODUCTION_GREEN',main_sha:'879c8730040afaf6caec6374b5057b7261fdcfe2',tree_sha:'da5e3b249d6e14266da5e191cb22c06205947948',production_pages_deploy_run:35275636873,production_live_resource_integrity_run:35275711398,products_browser_proof_run:35275711387,products_route_proof_run:35275711471,build_specific_proof_run:35275636939,client_ui_incident_state:'BUILD170_CLOSED_GREEN',client_ui_usability_proven:true,operator_regression_reported:false});
