      ...
      .on('head', {
        element(element) {
          ...
          if (isPublicRuntimeIntelligencePath(pathname)) {
            element.append('<link rel="stylesheet" href="/css/admin-context-help.css?v=467b198-shared-help"><script defer src="/public/js/admin-context-help.js?v=467b198-shared-help"></script>', { html: true });
