      ...
      .on('head', {
        element(element) {
          ...
          if (isPublicRuntimeIntelligencePath(pathname)) {
            element.append('<link data-dd-context-help-style="true" rel="stylesheet" href="/css/admin-context-help.css?v=467b234-workflow-recovery"><script defer src="/public/js/admin-context-help.js?v=467b234-workflow-recovery"></script>', { html: true });
